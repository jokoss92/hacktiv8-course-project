...
function train(pokemon, candy) {
  // code here
  pokemon.level = pokemon.level+candy
  if(pokemon.evolutionLine === undefined){
    return "Congratulations, your " + pokemon.name + " grew to LV. " + pokemon.level 
  } else if(pokemon.level >= pokemon.evolutionLine[0].level){
    if(pokemon.level >= pokemon.evolutionLine[1].level){
      return "Congratulations, your " + pokemon.name + " grew to LV. " + pokemon.level + ". And it evolved into " + pokemon.evolutionLine[0].name + " and "+ pokemon.evolutionLine[1].name
    }
    // if(pokemon.level >= pokemon.evolutionLine[2].level){
    //   return "Congratulations, your " + pokemon.name + " grew to LV. " + pokemon.level + ". And it evolved into " + pokemon.evolutionLine[0].name + ", "+ pokemon.evolutionLine[1].name + "and " + pokemon.evolutionLine[2].name
    // }
    return "Congratulations, your " + pokemon.name + " grew to LV. " + pokemon.level + ". And it evolved into " + pokemon.evolutionLine[0].name
  } 
  // for(var i=0; i<pokemon.evolutionLine.length; i++){
  //   console.log(pokemon.evolutionLine[i])
  // }
}
